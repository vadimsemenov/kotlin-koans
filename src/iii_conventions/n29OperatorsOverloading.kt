...
private data class TimeIntervals(val timeInterval: TimeInterval, val n: Int)

private operator fun TimeInterval.times(n: Int): TimeIntervals = TimeIntervals(this, n)

private operator fun MyDate.plus(timeIntervals: TimeIntervals): MyDate {
